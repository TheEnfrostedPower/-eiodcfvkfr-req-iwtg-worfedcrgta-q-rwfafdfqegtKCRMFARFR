		...
		while entity ~= nil do wait(0.5)
			...
			if v.Character ~= nil and not v.Character:GetAttribute("Hiding") then
				if canSeeTarget(v.Character,150) then
					...
					firesignal(game.ReplicatedStorage.EntityInfo.DeathHint.OnClientEvent, {"You were killed by whom you called Rebound","He can spawn in any room that you open!"," Stay out for him when you open the next 3-6 doors!"}, "Blue")
